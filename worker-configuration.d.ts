// Generated by Wrangler by running `wrangler types` (hash: 2b0e149aed5e56ef403e69071ecebc2d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_TOKEN_TTL_SECONDS" | "SELF_HOSTED" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "SYNC_TOKEN_SECRET" | "AUTH_EMAIL_FROM" | "WWW_BASE_URL" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "POLAR_STARTER_MONTHLY_PRODUCT_ID" | "POLAR_STARTER_ANNUAL_PRODUCT_ID" | "POLAR_SANDBOX" | "DEV_MODE">> {}
}
declare module "*.sql" {
	const value: string;
